...
\begin{outline}
  ...
  document or by accepting a digital file. The uploaded CV shall be stored and linked to
  ...
  to the backend upon completion.
    ...
    \3 \textbf{FR-C6c -- Receive Submission Confirmation:}
  ...
  \2 \textbf{FR-C7 -- Video Quality Feedback:}
  The system shall evaluate the quality of the recorded video submission (including audio
  clarity, lighting, and transcript confidence) and, if the submission falls below the
  minimum acceptable threshold, shall present a plain-language retry prompt to the candidate
  before the session ends. Up to two retries shall be permitted.
  ...
  description and a set of screening questions configured by the recruiter.
    ...
    detailed job description including role requirements and eligibility criteria.
    ...
    description, eligibility criteria, and screening questions. Changes shall take effect
    immediately for future applications while preserving a snapshot for existing applications.
  ...
  \2 \textbf{FR-R3 -- Set Scoring Threshold:}
  ...
  a specific job, ordered by composite AI score.
    ...
    \3 \textbf{FR-R4b -- View Video Interviews:}
    ...
    \3 \textbf{FR-R4c -- View AI Recommendation:}
    ...
    \3 \textbf{FR-R4d -- Filter and Search Applicants:}
  ...
  \2 \textbf{FR-R5 -- Make Hiring Decision:}
  ...
  the recruiter decisions log.
    ...
    \3 \textbf{FR-R5c -- Send to Human Interview:}
    ...
    \3 \textbf{FR-R5d -- Add Notes and Flags:}
  ...
  \2 \textbf{FR-R6 -- Report System Errors:}
  ...
  \2 \textbf{FR-R7 -- Edit Recruiter Profile:}
...
\begin{outline}
    ...
    \1 \textbf{Speech-to-Text Module:} This component converts spoken interview responses into text for further analysis. It is implemented using \textbf{Whisper Large v3}, which supports multilingual transcription.
